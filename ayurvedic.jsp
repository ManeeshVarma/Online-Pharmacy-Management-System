...
<body>
	<table class="first">
		...
		<td><a href="pass.jsp"><button style="height:40px;width:100px;">Password</button></a></td>
                <td><a href="user1.jsp"><button style="height:40px;width:100px;">Back</button></a></td>
		</tr>
	</table>
  ...
  try{
	...
	session.setAttribute("uname",n);	  
		...
		<tr height="100px" align="center">
			<td  class="second"><a href="https://www.canarabank.in/"><img class="pic" src="AYURVEDIC.jpg" style="height:200px; width:250px; border-color:#527a7a; " border="3"></a>
                            <p >AYURVEDIC</p></td>
